	...
	{if isset($error)}
			<div id="blogpage">
				<div class="blog-detail">
					<div class="alert alert-warning">{l s='Sorry, We are updating data, please come back later!!!!' d='Module.PsBlog'}</div>
				</div>
			</div>
		{else}	
		<div id="blogpage">
			<article class="blog-detail">
				...
				{/if}
                 <div class="blog-meta">
					...
					<span class="blog-author">
						<span> {l s='Posted By' d='Module.PsBlog'}: </span>
					...
					<span class="blog-cat"> 
						<i class="fa fa-list"></i>{l s='In' d='Module.PsBlog'}: 
					...
					<span class="blog-created">
						<i class="fa fa-calendar"></i> {l s='On' d='Module.PsBlog'}:
					...
					<span class="blog-ctncomment">
						<i class="fa fa-comments-o"></i>{l s='Comment' d='Module.PsBlog'}: 
						{$blog_count_comment|intval}
					</span>
					{/if}
					{if isset($blog->hits)&&$config->get('item_show_hit','1')}
					<span class="blog-hit">
						<i class="fa fa-heart"></i>{l s='Hit' d='Module.PsBlog'}:
						{$blog->hits|intval}
					</span>
					{/if}
				</div>
				...
				{if !empty($samecats)}
					<div class="col-lg-6 col-md-6 col-xs-12">
						<h4>{l s='In Same Category' d='Module.PsBlog'}</h4>
						<ul>
					...
					<div class="col-lg-6 col-md-6 col-xs-12">
						<h4>{l s='Related by Tags' d='Module.PsBlog'}</h4>
						<ul>
				...
				{else}
				<div class="alert alert-warning">{l s='Sorry, This blog is not avariable. May be this was unpublished or deleted.' d='Module.PsBlog'}</div>
				{/if}
