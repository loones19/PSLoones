   ...
   /**
        ...
        $tabs = array(
            ...
            'shipping'        => array(
                ...
                'sub_tab' => array(
                    ...
                    'search_rma'  => array(
                        'label' => $this->correos_instance->l('Search Returns', 'correosadminforms'),
                        'href'  => 'search_rma',
            ...
            'sub_tab' => array(
                'request_collection' => array(
                        'label' => $this->correos_instance->l('Request Collections', 'correosadminforms'),
                        'href'  => 'request_collection',
                        'icon'  => 'shipping.png',
                    ),
    ...
    public function getServiceUrlsForm($correos_config)
    {
        ...
        $options = array(
            ...
            'url_servicepaq' => array(
                'name'     => 'url_servicepaq',
                'prefix'   => '',
                'label'    => $this->correos_instance->l('URL CityPaq', 'correosadminforms'),
                'type'     => 'textbox',
    ...
    public function getSenderForm($correos_config)
    {
        ...
        $options = array(
            'remove_sender' => array(
                'id'     => 'remove_sender',
                'value'    =>  $this->correos_instance->l('Remove sender', 'correosadminforms'),
                'type'     => 'submit',
                'class'    => 'btn-primary'
            ),
            'add_sender' => array(
            ...
            'select_sender' => array(
                'name'     => 'select_sender',
                'prefix'   => '',
                'label'    => $this->correos_instance->l('Required fields', 'correosadminforms'),
            ...
            'sender_default' => array(
                'name'     => 'sender_default',
                'prefix'   => '',
                'label'    => $this->correos_instance->l('Default Sender', 'correosadminforms'),
                'type'     => 'switch',
                'data'    => array(
                    '1' => $this->correos_instance->l('Yes', 'correosadminforms'),
                    '0' => $this->correos_instance->l('No', 'correosadminforms')),
                'default_option' => '0',
                'help'     => $this->correos_instance->l('Set as default Sender (to show as first in the Senders list)', 'correosadminforms')
            ),
            'sender_nombre' => array(
                'name'     => 'sender_nombre',
                'prefix'   => '',
                ...
                'help'     => $this->correos_instance->l('Required if not filled Company+Contact person', 'correosadminforms')
            ),
            ...
            'sender_empresa' => array(
                ...
                'help'     => $this->correos_instance->l('Required if not filled Sender name+Sender surname', 'correosadminforms')
            ),
