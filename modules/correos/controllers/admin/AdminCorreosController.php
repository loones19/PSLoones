...
class AdminCorreosController extends ModuleAdminController
{
    ...
    {
        die(
           Tools::jsonEncode( CorreosAdmin::getCollectionDetails(Tools::getValue('id_collection')))
        );
    }
    public function ajaxProcessgetLastTracking()
    {
        $tracking = CorreosAdmin::getTrackingHistory(Tools::getValue('shipping_code'));
        $last_tracking = '';
