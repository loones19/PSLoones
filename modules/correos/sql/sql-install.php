...
('S0133', 'Paq Estándar Oficina', 'Envíos en 2-3 días a la oficina que tú elijas', 0),
('S0176', 'Paq Premium CityPaq', 'Envíos en 1-2 días al terminal que tú elijas', 0),
('S0178', 'Paq Estándar CityPaq', 'Envíos en 2-3 días al terminal que tú elijas', 0),
('S0235', 'Paq Premium Domicilio', 'Entrega a domicilio en 1-2 días', 0),
('S0236', 'Paq Premium Oficina', 'Envíos en 1-2 días a la oficina que tú elijas', 0),
('S0360', 'Paq Light Internacional', 'Envíos a domicilio con seguimiento, sin firma', 0),
('S0410', 'Paq Standard Internacional', 'Envíos Preferentes a domicilio', 0);";
...
$sql[] ="INSERT INTO `"._DB_PREFIX_."correos_configuration` (`name`, `value`) VALUES
   ...
   "cashondeliveryplus,cashondeliveryfee,ps_cashondelivery,ps_cashondelivery'),
...
$sql[] = 'DROP TABLE IF EXISTS `'._DB_PREFIX_.'correos_collection`;';
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'correos_collection` (
  ...
  `status` varchar(15) COLLATE utf8_spanish_ci NOT NULL DEFAULT \'Solicitada\',
  PRIMARY KEY (`id`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;';

$sql[] = 'DROP TABLE IF EXISTS `'._DB_PREFIX_.'correos_rma`;';

$sql[] = 'CREATE TABLE `'._DB_PREFIX_.'correos_rma` (
    `id_order` int(10) UNSIGNED NOT NULL,
    `shipment_code` varchar(250) DEFAULT NULL,
