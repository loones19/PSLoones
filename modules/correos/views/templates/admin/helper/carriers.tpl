      ...
      <tr>
        ...
        {if $ps_version eq '1.6'}
          {if file_exists($path_module|cat:'views/img/'|cat:$logo_prefix|cat:$correos_carrier.code|cat:'.jpg'|lower)}
            <img class="imgm img-thumbnail" style="vertical-align:middle" src="{$path_logo|escape:'htmlall':'UTF-8'}{$logo_prefix|escape:'htmlall':'UTF-8'}{$correos_carrier.code|lower|escape:'htmlall':'UTF-8'}.jpg" alt="" title="" />
          {/if}
        {else}
           <img class="imgm img-thumbnail" style="vertical-align:middle" src="{$path_logo|escape:'htmlall':'UTF-8'}logo_ps17_generic.jpg" alt="" title="" />
        {/if}
        </td>
