...
class Tm_Categorylist extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('TM - Category List Block', array(), 'Modules.CategoryList');
    ...
    public function getdatoscat()
    {
        $sql = 'SELECT * FROM '._DB_PREFIX_.'loones_precio';
        return Db::getInstance()->executeS($sql);
    }
