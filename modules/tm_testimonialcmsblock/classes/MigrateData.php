...
class MigrateData
{
    ...
    $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmtestimonialcmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmtestimonialcmsblockinfo_lang` il ON il.`id_tmtestimonialcmsblockinfo` = i.`id_tmtestimonialcmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmtestimonialcmsblockinfo->text = reset($customTexts);
