...
@set_time_limit(600);
		...
		if(file_exists($classes_flag ))die("The classes has been installed before.");
		
				$controllers_flag = _PS_ROOT_DIR_ . "/modules/agilemultipleseller/override/controllers.flg";
		if(file_exists($controllers_flag))
		{
		...
		die("The override classes has been installed");
